...
type Customer struct {
	...
	LhuReceiverName    string `json:"lhu_receiver_name" gorm:"column:lhu_receiver_name"`
	LhuReceiverContact string `json:"lhu_receiver_contact" gorm:"column:lhu_receiver_contact"`
